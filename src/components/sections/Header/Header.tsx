  ...
  <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8 " aria-label="Global">
    <div className="flex lg:flex-1">
      <a href="#" className="-m-1.5 p-1.5">
        ...
        <img className="h-8 w-auto" src={meet} alt=""/>
      </a>
    </div>
    ...
    <div className="hidden lg:flex lg:gap-x-12">
      ...
      <NavLink to='/' className="text-sm/6 font-semibold text-gray-900">Eventos</NavLink>
      <NavLink to='people' className="text-sm/6 font-semibold text-gray-900">Personas</NavLink>
      <NavLink to='about' className="text-sm/6 font-semibold text-gray-900">Acerca de</NavLink>
    </div>
